...
async def test_position_in_range_extend_realtime_first_candle(
    ...
    row = Candle({CandleCol.CLOSE: 140}, timestamp=row_time)
...
async def test_position_in_range_extend_realtime_same_day(candles: "CandleStoreTest"):
    ...
    first_row = Candle({CandleCol.CLOSE: 140}, timestamp=first_time)
    await indicator.extend_realtime("AAPL", first_row)

    second_time = datetime(2023, 1, 11, 10, 0)
    second_row = Candle({CandleCol.CLOSE: 145}, timestamp=second_time)
...
async def test_position_in_range_extend_realtime_new_day(candles: "CandleStoreTest"):
    ...
    day1_row = Candle({CandleCol.CLOSE: 140}, timestamp=day1_time)
    ...
    day2_row = Candle({CandleCol.CLOSE: 145}, timestamp=day2_time)
...
async def test_position_in_range_extend_realtime_multiple_symbols(
    ...
    aapl_row = Candle({CandleCol.CLOSE: 140}, timestamp=aapl_time)
    ...
    msft_row = Candle({CandleCol.CLOSE: 245}, timestamp=msft_time)
...
async def test_position_in_range_edge_cases(candles: "CandleStoreTest"):
    ...
    low_row = Candle({CandleCol.CLOSE: 130}, timestamp=low_time)
    ...
    high_row = Candle({CandleCol.CLOSE: 150}, timestamp=high_time)
    ...
    above_row = Candle({CandleCol.CLOSE: 160}, timestamp=above_time)
    ...
    below_row = Candle({CandleCol.CLOSE: 120}, timestamp=below_time)
